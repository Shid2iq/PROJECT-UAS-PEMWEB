           ...
           <nav class="navbar navbar-expand-lg navbar-light bg-white py-5">
            ...
            <header class="py-5">
                <div class="container px-5 pb-5">
                    <div class="row gx-5 align-items-reverse">
                        <div class="col-xxl-5">
                            <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                                ...
                                <div class="carousel-inner">
                                  ...
                                  <div class="carousel-item">
                                    <img class="d-block w-100" src="assets/img/one piece.webp" alt="Second slide">
                                  </div>
                                  <div class="carousel-item">
                                    <img class="d-block w-100" src="assets/img/Suzume.png" alt="Third slide">
                                  </div>
                                </div>
                        ...
                        <div class="col-xxl-7">
                              ...
                              <div class=" text-xxl-start">
                                ...
                                <h4 class="fw-bolder mb-5"><span class="mr-5 border rounded">GENRE</span> <span class="border rounded">RATING</span></h4>
                ...
                <div class="container px-5 pb-5">
                    <div class="row gx-5 align-items-center">
                        <div class="col-xxl-5">
                            <!-- Header text content-->
                            <div class=" text-xxl-start">
                                <h1 class="display-3 fw-bolder mb-5 "><span class="text-gradient d-inline">Featured Products</span></h1>
